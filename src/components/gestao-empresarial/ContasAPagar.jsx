...
const ContasAPagar = () => {
    ...
    const {
        ...
        update,
        remove,
    } = useSupabaseCrud('gestao_contas_pagar');
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="flex gap-3 flex-wrap">
                    <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-xl px-4 py-3">
                        <p className="text-xs text-yellow-200">Em aberto</p>
                    ...
                    orderedBills.map((bill) => (
                        ...
                        >
                            <div>
                                ...
                                {bill.paid_at && (
                                    <p className="text-xs text-green-300 mt-1">
                                        Pago em {new Date(bill.paid_at).toLocaleString('pt-BR')}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="flex items-center gap-4 flex-wrap">
                                ...
                                <span
                                    className={`px-2 py-1 rounded text-xs ${bill.status === 'pago'
